...
errs.forEach(e=>{let v=0;if(e.ovr!==undefined){v=e.ovr}else{
const isP=t=>t.match(/^[^\w\u0900-\u097F]+$/);const pV=t=>{if(t.match(/[.?!|\u0964]/))return parseFloat(r.pun);if(t.includes(','))return parseFloat(r.com);return 0};
if(e.t==='f'){v=isP(e.u.t)?pV(e.u.t):(r.sub==='d'?1:0.5)}else if(e.t==='m'){v=isP(e.o.t)?pV(e.o.t):1}
