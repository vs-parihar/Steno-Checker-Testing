...
au.ontimeupdate = () => {
    ...
    const d = au.duration, c = au.currentTime, p = (c / d) * 100, w = parseFloat($('wi').value) || 150, lagS = (20 / w) * 60, effD = d - lagS * 2, relC = Math.max(0, c - lagS), relP = effD > 0 ? Math.min(100, relC / effD * 100) : p;
    $('pf').style.width = p + '%';
