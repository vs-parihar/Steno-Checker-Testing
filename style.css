:root{--in:#6366f1;--bg:#000;--fg:#e2e8f0;--bd:rgba(99,102,241,0.5);--re:rgba(239,68,68,0.5);--gr:rgba(34,197,94,0.5);--ye:rgba(234,179,8,0.5);--sc:1;--ts:14px;--p-bg:#0a0a0a;--inp-bg:#111}
body.light-mode{--bg:#f8fafc;--fg:#0f172a;--bd:rgba(99,102,241,0.4);--p-bg:#fff;--inp-bg:#f1f5f9;--re:rgba(239,68,68,0.8);--gr:rgba(34,197,94,0.8)}
...
.m-err{color:#ef4444;text-decoration:line-through;margin:0 1px}.m-mis{color:#eab308;border-bottom:1px dashed #eab308;margin:0 1px}.m-h{color:#6366f1;margin:0 1px}.m-d{border:1px solid #ef4444;color:#ef4444;padding:0 1px}
...
.e-ctx{background:var(--bd);color:#fff;border-radius:2px;padding:0 3px;margin:0 1px}.e-w{font-weight:bold;margin:0 2px;cursor:pointer}
.res-view{background:var(--bg);border:1px solid var(--bd);overflow-y:auto;padding:4px;font-size:12px;line-height:1.6;white-space:pre-wrap;flex:1;width:0;height:100%;font-family:system-ui;color:var(--fg)}
.c-ins{color:#ef4444;font-weight:bold;cursor:pointer;background:rgba(239,68,68,0.1)}.c-mis{color:#eab308;font-weight:bold;cursor:pointer;background:rgba(234,179,8,0.1)}.c-sp{color:#6366f1;font-weight:bold;cursor:pointer}.c-dbl{color:#ef4444;border-bottom:1px solid #ef4444;cursor:pointer}
.w-n{cursor:pointer;opacity:0.8}.ctx-hl{background:rgba(99,102,241,0.5);border-radius:2px;color:#fff}
